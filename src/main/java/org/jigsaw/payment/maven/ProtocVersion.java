...
public class ProtocVersion {
	...
	public static final ProtocVersion PROTOC_VERSION = new ProtocVersion(null, null, "3.5.0");
	...
	public static ProtocVersion getVersion(String spec) {
		...
		if (version.mVersion.length() == 3) { // "123" -> "1.2.3"
			String dotVersion = version.mVersion.charAt(0) + "." + version.mVersion.charAt(1) + "."
